    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-seleb-hiburan">Selebriti & Hiburan</li>
              <li data-filter=".filter-lingkungan-hidup">Lingkungan Hidup</li>
              <li data-filter=".filter-wisata-kuliner">Wisata & Kuliner</li>
              <li data-filter=".filter-seni-budaya">Seni & Budaya</li>
              <li data-filter=".filter-politik">Politik</li>
              <li data-filter=".filter-gaya-hidup">Gaya Hidup</li>
              <li data-filter=".filter-perempuan">Perempuan</li>
              <li data-filter=".filter-tek-sains">Teknologi & Sains</li>
              <li data-filter=".filter-agama">Keagamaan & Spiritualisme</li>
              <li data-filter=".filter-fashion">Fashion</li>
              <li data-filter=".filter-bisnis">Bisnis & UKM</li>
              <li data-filter=".filter-sosial">Sosial</li>
              <li data-filter=".filter-profesi-alumni">Profesi & Alumni</li>
              <li data-filter=".filter-kepemudaan">Kepemudaan</li>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wisata-kuliner wow fadeInUp">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4><a href="#">Nama Komunitas</a></h4>
              </div>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-kesehatan wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="<?php echo base_url(); ?>tema/img/portfolio/app1.jpg" class="img-fluid" alt="">
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-olahraga wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-kesehatan wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-pendidikan wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-pendidikan wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-perempuan wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="<?php echo base_url(); ?>tema/img/portfolio/card1.jpg" class="img-fluid" alt="">
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-sejarah wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-olahraga wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="<?php echo base_url(); ?>tema/img/portfolio/web1.jpg" class="img-fluid" alt="">
              </figure>
